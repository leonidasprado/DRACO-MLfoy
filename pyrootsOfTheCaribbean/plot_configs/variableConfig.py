...
variables["BDT_common5_input_HT"]                                   = Variable(bin_range = [0.,1500.])
variables["BDT_common5_input_HT_tag"]		                        = Variable(bin_range = [0.0,1500.0])
variables["Evt_HT_tagged"]                                   = Variable(bin_range = [0.0,1100.0])
...
variables["Evt_CSV_Average"]		                                = Variable(bin_range = [0.3,1.0])
...
variables["Evt_HT"]		                                            = Variable(bin_range = [0.0,1600.0])
...
variables["Jet_CSV[0]"]		                                        = Variable(bin_range = [-0.2,1.0])
variables["Jet_CSV[1]"]		                                        = Variable(bin_range = [-0.2,1.0])
variables["Jet_CSV[2]"]		                                        = Variable(bin_range = [-0.2,1.0])
variables["Jet_CSV[3]"]		                                        = Variable(bin_range = [-0.2,1.0])
...
variables["Jet_Pt[0]"]		                                        = Variable(bin_range = [30.0,500.0])
variables["Jet_Pt[1]"]		                                        = Variable(bin_range = [30.0,300.0])
variables["Jet_Pt[2]"]		                                        = Variable(bin_range = [30.0,200.0])
variables["Jet_Pt[3]"]		                                        = Variable(bin_range = [30.0,200.0])
variables["LooseLepton_Eta[0]"]		                                = Variable(bin_range = [-2.4,2.4])
variables["LooseLepton_Pt[0]"]		                                = Variable(bin_range = [0.0,350.0])
...
variables["N_BTagsL"]                               = Variable(bin_range = [1.5,9.5],           nbins = 8)
variables["N_BTagsM"]                               = Variable(bin_range = [1.5,7.5],           nbins = 6)
...
variables["CSV[3]"]                                 = Variable(bin_range = [0.0,1.0])
...
variables["BDT_common5_input_all_sum_pt_with_met"]  = Variable(bin_range = [0.,1500.])
...
variables["BDT_common5_input_aplanarity"]                       = Variable(bin_range = [0.,0.42])
...
variables["Evt_M_MinDeltaRTaggedJets"]                          = Variable(bin_range = [0.,400.])
variables["Evt_M_PrimaryLepton"]                                = Variable(bin_range = [-0.25,0.35])
variables["Evt_M_TaggedJetsAverage"]                            = Variable(bin_range = [5.,50.])
variables["Evt_M_TaggedJetsClosestTo125"]                       = Variable(bin_range = [50.,250.])
variables["Evt_M_Total"]                                        = Variable(bin_range = [0.,2000.])
