...
import variable_sets.dnnVariableSet_5tag as variable_set
from evaluationScripts.plotVariables import variablePlotter

# location of input dataframes
data_dir = "/afs/cern.ch/user/l/lprado/work/DNNInputFiles/DNN_ttHH_2017_v2_3M2L"

# output location of plots
plot_dir = "/afs/cern.ch/user/l/lprado/work/SomePlots_ttHH_3M2L"
...
plotter.addCategory("5j_ge5t")
#plotter.addCategory("ge6j_ge3t")
#plotter.addCategory("ge4j_ge3t")
plotter.addCategory("6j_ge5t")
plotter.addCategory("7j_ge5t")
plotter.addCategory("ge8j_ge5t")
plotter.addCategory("ge5j_ge5t")
