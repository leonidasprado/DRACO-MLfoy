...
import DRACO_Frameworks.DNN.DNN3_ttbb as DNN
...
event_nominal=["ttHH4b", "ttbb", "tt2b","ttb","ttcc","ttlf","ttbbb","tt4b"]
#this nominal_extra is mainly used for testing
...
inPath   = "/afs/cern.ch/user/l/lprado/work/InputFiles/ttHH-allVar-ttbbOpenLoops-tt4bStudy"
...
savepath = basedir+"/workdir/"+"ttHH_2017_predict_tt4b_OpenLoops_"+str(JTcategory)
