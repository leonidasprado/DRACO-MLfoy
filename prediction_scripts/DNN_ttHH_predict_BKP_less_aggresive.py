...
import DRACO_Frameworks.DNN.DNN3_less_aggressive as DNN
...
event_nominal=["ttHH4b", "ttbb", "tt2b","ttb","ttcc","ttlf","ttHbb"]
...
event_syst=["ttHH4b_"+str(sys.argv[1]),"ttbb_"+str(sys.argv[1]),"tt2b_"+str(sys.argv[1]),"ttb_"+str(sys.argv[1]),"ttcc_"+str(sys.argv[1]),"ttlf_"+str(sys.argv[1]),"ttHbb_"+str(sys.argv[1])]
