...
import DRACO_Frameworks.DNN.DNN3_4nodes as DNN
...
event_nominal=["ttHH4b", "tthf","ttcc","ttlf"]
event_nominal_extra=["tthf"]
#event_nominal_extra=["ttHbb"]
event_data=["data_obs"]
event_JESUp=["ttHH4b_JESUp", "tthf_JESUp","ttcc_JESUp","ttlf_JESUp"]
event_JESDown=["ttHH4b_JESDown", "tthf_JESDown","ttcc_JESDown","ttlf_JESDown"]
event_JERUp=["ttHH4b_JERUp", "tthf_JERUp","ttcc_JERUp","ttlf_JERUp"]
event_JERDown=["ttHH4b_JERDown", "tthf_JERDown","ttcc_JERDown","ttlf_JERDown"]
...
inPath   = "/afs/cern.ch/user/l/lprado/work/InputFiles/ttHH_4nodes_syst-topvar"
...
savepath = basedir+"/workdir/"+"ttHH_predict_4nodes_topVar_"+str(JTcategory)
