...
subD2=fnew.mkdir("tthf_node")
subD3=fnew.mkdir("ttcc_node")
subD4=fnew.mkdir("ttlf_node")
RDirectory = [subD1,subD2,subD3,subD4]

#The root file being open
f=ROOT.TFile(filename)
subD=["ttHH4b_node","tthf_node","ttcc_node","ttlf_node"]
processes=["ttHH4b","tthf","ttcc","ttlf"]
number_data=0
