...
dataset = root2pandas.Dataset(
    outputdir   = "/afs/cern.ch/user/l/lprado/work/DNNInputFiles/DNN_ttHH_2017_v3-all_var/",
    naming      = "dnn",
    addCNNmap   = False,
    addMEM      = False)
...
dataset.addSample(
    sampleName  = "TTToSL",
    ntuples     = "/eos/user/l/lprado/ttHH_ntuples/TTToSemiLeptonic_v3_forDNN/*nominal*.root",
