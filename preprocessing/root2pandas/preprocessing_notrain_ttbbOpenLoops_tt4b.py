...
dataset = root2pandas.Dataset(
    outputdir   = "/afs/cern.ch/user/l/lprado/work/InputFiles/ttHH-allVar-ttbbOpenLoops-tt4bStudy/",
    naming      = "dnn",
    addCNNmap   = False,
    addMEM      = False)
...
dataset.addSample(
    sampleName  = "TTToSL",
    ntuples     = "/eos/user/l/lprado/TTbb_Powheg_Openloops_tt4b/*nominal*.root",
