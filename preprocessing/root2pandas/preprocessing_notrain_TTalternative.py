...
ttbarJESup_categories.addCategory("ttbar_JESUp", selection = None)

ttbarJESdown_categories = root2pandas.EventCategories()
ttbarJESdown_categories.addCategory("ttbar_JESDown", selection = None)

ttbarJERup_categories = root2pandas.EventCategories()
ttbarJERup_categories.addCategory("ttbar_JERUp", selection = None)

ttbarJERdown_categories = root2pandas.EventCategories()
ttbarJERdown_categories.addCategory("ttbar_JERDown", selection = None)
...
dataset = root2pandas.Dataset(
    outputdir   = "/afs/cern.ch/user/l/lprado/work/InputFiles/ttHH_TTalternative_syst-topvar/",
    naming      = "dnn",
    addCNNmap   = False,
    addMEM      = False)
